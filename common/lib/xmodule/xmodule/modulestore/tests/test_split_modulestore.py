...
class SplitModuleTest(unittest.TestCase):
    ...
    def bootstrapDB():
        ...
        to_publish = BlockUsageLocator(
            CourseLocator(org="testx", course="wonderful", run="run", branch="draft"),
            block_type='course',
            block_id="head23456"
        )
        destination = CourseLocator(org="testx", course="wonderful", run="run", branch="published")
...
class TestHasChildrenAtDepth(SplitModuleTest):
    ...
    def test_has_children_at_depth(self):
        course_locator = CourseLocator(
            org='testx', course="GreekHero", run="run", branch='draft'
        )
...
class SplitModuleCourseTests(SplitModuleTest):
    ...
    def test_get_course(self):
        ...
        '''
        locator = CourseLocator(org='testx', course="GreekHero", run="run", branch="draft")
        ...
        locator = CourseLocator(org='testx', course="wonderful", run="run", branch='published')
        course = modulestore().get_course(locator)
        published_version = course.location.version_guid

        locator = CourseLocator(org='testx', course="wonderful", run="run", branch='draft')
        course = modulestore().get_course(locator)
    ...
    def test_get_course_negative(self):
        ...
        with self.assertRaises(ItemNotFoundError):
            modulestore().get_course(CourseLocator(org='edu', course="nosuchthing", run="run", branch='draft'))
        with self.assertRaises(ItemNotFoundError):
            modulestore().get_course(CourseLocator(org='testx', course="GreekHero", run="run", branch='published'))
...
class SplitModuleItemTests(SplitModuleTest):
    ...
    def test_has_item(self):
        ...
        course = 'GreekHero'
        run = 'run'
        course_locator = CourseLocator(org=org, course=course, run=run, branch='draft')
    ...
    def test_negative_has_item(self):
        ...
        locator = BlockUsageLocator(
            CourseLocator(org="foo", course="doesnotexist", run="run", branch='draft'),
            block_type="course",
            block_id="head23456"
        )
    ...
    def test_get_item(self):
        ...
        '''
        hero_locator = CourseLocator(org="testx", course="GreekHero", run="run", branch='draft')
    ...
    def test_has_changes(self):
        ...
        """
        draft_course = CourseLocator(org='testx', course="GreekHero", run="run", branch='draft')
        published_course = CourseLocator(org='testx', course="GreekHero", run="run", branch='published')
    ...
    def test_get_non_root(self):
        # not a course obj
        locator = BlockUsageLocator(
            CourseLocator(org='testx', course="GreekHero", run="run", branch='draft'), 'chapter', 'chapter1'
        )
        block = modulestore().get_item(locator)
        self.assertEqual(block.location.org, "testx")
        self.assertEqual(block.location.course, "GreekHero")
        ...
        # in published course
        locator = BlockUsageLocator(
            CourseLocator(org='testx', course="wonderful", run="run", branch='published'), 'course', 'head23456'
        )
        ...
        # no such course or block
        locator = BlockUsageLocator(
            CourseLocator(org='doesnotexist', course="doesnotexist", run="run", branch='draft'), 'course', 'head23456'
        )
        with self.assertRaises(ItemNotFoundError):
            modulestore().get_item(locator)
        locator = BlockUsageLocator(
            CourseLocator(org='testx', course="wonderful", run="run", branch='draft'), 'html', 'doesnotexist'
        )
        with self.assertRaises(ItemNotFoundError):
            modulestore().get_item(locator)
    ...
    def test_get_parents(self):
        ...
        '''
        locator = BlockUsageLocator(
            CourseLocator(org='testx', course="GreekHero", run="run", branch='draft'),
        ...
        self.assertEqual(parents[0].course, "GreekHero")
        self.assertEqual(parents[0].run, "run")
    ...
    def test_get_children(self):
        ...
        """
        locator = BlockUsageLocator(
            CourseLocator(org='testx', course="GreekHero", run="run", branch='draft'), 'course', 'head12345'
        )
        block = modulestore().get_item(locator)
...
class TestItemCrud(SplitModuleTest):
    ...
    def test_create_parented_item(self):
        ...
        locator = BlockUsageLocator(
            CourseLocator(org='testx', course="wonderful", run="run", branch='draft'), 'course', 'head23456'
        )
    ...
    def test_unique_naming(self):
        ...
        locator = BlockUsageLocator(
            CourseLocator(org='guestx', course="contender", run="run", branch='draft'), 'course', 'head345679'
        )
        category = 'problem'
    ...
    def test_encoded_naming(self):
        ...
        """
        course_key = CourseLocator(org='guestx', course="contender", run="run", branch='draft')
    ...
    def test_update_children(self):
        ...
        """
        locator = BlockUsageLocator(
            CourseLocator(org='testx', course="GreekHero", run="run", branch='draft'), 'chapter', 'chapter3'
        )
        block = modulestore().get_item(locator)
...
class TestCourseCreation(SplitModuleTest):
    ...
    def test_cloned_course(self):
        ...
        """
        original_locator = CourseLocator(org='testx', course="wonderful", run="run", branch='draft')
    ...
    def test_derived_course(self):
        ...
        """
        original_locator = CourseLocator(org='guestx', course="contender", run="run", branch='draft')
...
class TestInheritance(SplitModuleTest):
    ...
    def test_inheritance(self):
        ...
        locator = BlockUsageLocator(
            CourseLocator(org='testx', course="GreekHero", run="run", branch='draft'), 'problem', 'problem3_2'
        )
        node = modulestore().get_item(locator)
        # inherited
        self.assertEqual(node.graceperiod, datetime.timedelta(hours=2))
        locator = BlockUsageLocator(
            CourseLocator(org='testx', course="GreekHero", run="run", branch='draft'), 'problem', 'problem1'
        )
        node = modulestore().get_item(locator)
        # overridden
...
class TestPublish(SplitModuleTest):
    ...
    def test_publish_safe(self):
        ...
        """
        source_course = CourseLocator(org='testx', course="GreekHero", run="run", branch='draft')
        dest_course = CourseLocator(org='testx', course="GreekHero", run="run", branch="published")
    ...
    def test_exceptions(self):
        ...
        destination_course = CourseLocator(org='fake', course="Unknown", run="run", branch="published")
        head = source_course.make_usage_key('course', "head12345")
        chapter3 = source_course.make_usage_key('chapter', 'chapter3')
        ...
        destination_course = CourseLocator(org='testx', course="GreekHero", run="run", branch="published")
        with self.assertRaises(ItemNotFoundError):
            modulestore().xblock_publish(self.user, source_course, destination_course, [chapter3], None)
